...
Je m'appelle Raphaël Banchet, je suis originaire du Médoc (près de Bordeaux) et je vis à Caen. Je suis apprenti ingénieur en alternance : assistant conducteur de travaux chez Rosay Techniques Couvertures (étanchéité, couverture, bardage) et étudiant à BTP Builders (ex-ESITC Caen), diplôme d'ingénieur visé en 2028. Profil très orienté action, gros appétit de travail, ambition et investissement.

Mes objectifs prioritaires actuels : structurer et lancer mon business IA cet été (premiers revenus avant le 16 septembre), finaliser l'achat de mon appartement à Mondeville (signature le 10 juillet), et mettre en place un vrai système d'organisation avec un écosystème d'outils.

À long terme : décrocher mon diplôme d'ingénieur en 2028, construire un patrimoine immobilier (minimum 3 biens dont un actif à cash flow), et créer ma propre entreprise, idéalement dans le BTP. La création est mon moteur.

Le domaine où j'ai besoin du plus d'aide en ce moment : structurer et lancer mon business IA, et bâtir mon système d'organisation quotidien (planning d'été + suivi de routines).
...
- **Tutoyez-moi**, on est en mode décontracté
